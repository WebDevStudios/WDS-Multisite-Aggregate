<div class="wrap">
	...
	<ol><li><p><input name="tags_blog" type="text" id="tags_blog" style="width: 35%" value="<?php echo esc_attr( $options->get( 'tags_blog', 'tags' ) ); ?>" size="45" /></p>
	...
	<table class="form-table">
		<tr valign="top">
			...
			<td>
				<p><?php printf( __( 'Blog ID: %s <strong>OR</strong>', 'wds-multisite-aggregate' ), '<input name="populate_blog" type="text" id="populate_blog" style="width: 15%" value="" size="5" />' ); ?> <input name="populate_all_blogs" type="checkbox" id="populate_all_blogs" value="1" /> <?php _e( 'All blogs', 'wds-multisite-aggregate' ); ?></p>
